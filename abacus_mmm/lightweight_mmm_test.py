...
from abacus_mmm import abacus_mmm
from abacus_mmm import models


class abacusMmmTest(parameterized.TestCase):

  @classmethod
  def setUpClass(cls):
    super(abacusMmmTest, cls).setUpClass()
    cls.national_mmm = abacus_mmm.abacusMMM()
    cls.national_mmm.fit(
        ...
        number_samples=4,
        number_chains=1)
    cls.geo_mmm = abacus_mmm.abacusMMM()
    cls.geo_mmm.fit(
  ...
  def test_instantiate_model_correctly_from_available_models(
    ...
    mmm_object = abacus_mmm.abacusMMM(model_name=model_name)
  ...
  def test_instantiate_model_wrong_raises_valueerror(self):
    with self.assertRaises(ValueError):
      abacus_mmm.abacusMMM(model_name="non_existing_model")
  ...
  def test_fit_wrong_inputs_raises_value_error(
    ...
    mmm_object = abacus_mmm.abacusMMM()
  ...
  @parameterized.named_parameters([
      ...
      dict(
          ...
          custom_priors={models._INTERCEPT: abacus_mmm.abacusMMM()}),
  ])
  ...
  def test_default_mmm_instances_equal_each_other(self):
    self.assertEqual(abacus_mmm.abacusMMM(),
                     abacus_mmm.abacusMMM())
  ...
  def test_default_carryover_mmm_instance_only_equals_carryover_mmms(
    ...
    carryover_mmm = abacus_mmm.abacusMMM(model_name="carryover")
    other_mmm = abacus_mmm.abacusMMM(model_name=model_name)
  ...
  def test_fitted_mmm_does_not_equal_default_mmm(self, media_mix_model):
    default_mmm_object = abacus_mmm.abacusMMM()

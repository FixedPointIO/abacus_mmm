...
from impl.abacus_mmm.abacus_mmm.utils import load_model as lwmmm_load_model
from impl.abacus_mmm.abacus_mmm.utils import save_model as lwmmm_save_model
...
def save_model(mmm, results_dir):
    """
    save the abacus mmm model file to the file system

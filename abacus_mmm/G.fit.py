...
from abacus_mmm import optimize_media
from abacus_mmm import plot
from abacus_mmm import preprocessing
from abacus_mmm import utils

from abacus_mmm import abacus_mmm
from abacus_mmm.utils import get_time_seed
...
def fit_abacus_mmm(
    ...
    """
    fit a abacus mmm model to input_data
    ...
    :return: abacusMMM instance
    """
    model_name = config.get("model_name")
    assert model_name in (  # this setting is not optional
        constants.FIT_abacus_MMM_MODELNAME_ADSTOCK,
        constants.FIT_abacus_MMM_MODELNAME_HILL_ADSTOCK,
        constants.FIT_abacus_MMM_MODELNAME_CARRYOVER,
    ), model_name
    ...
    # manually generate a seed in the same way as abacus mmm's
    ...
    # the following jax option.  See https://github.com/google/abacus_mmm/issues/77.
    #
